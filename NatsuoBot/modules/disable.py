...
from NatsuoBot.modules.helper_funcs.misc import is_module_loaded
import NatsuoBot.modules.sql.blacklistusers_sql as bsql

FILENAME = __name__.rsplit(".", 1)[-1]

# If module is due to be loaded, then setup all the magical handlers
if is_module_loaded(FILENAME):
    from NatsuoBot.modules.helper_funcs.chat_status import user_admin, is_user_admin
    from telegram.ext.dispatcher import run_async

    from NatsuoBot.modules.sql import disable_sql as sql
