...
from NatsuoBot import SUDO_USERS, WHITELIST_USERS, dispatcher
from NatsuoBot.modules.helper_funcs.chat_status import (
    bot_admin, can_restrict, connection_status, is_user_admin, user_admin,
    user_admin_no_reply)
from NatsuoBot.modules.log_channel import loggable
from NatsuoBot.modules.sql import antiflood_sql as sql
...
from NatsuoBot.modules.helper_funcs.chat_status import is_user_admin, user_admin, can_restrict
from NatsuoBot.modules.helper_funcs.string_handling import extract_time
from NatsuoBot.modules.log_channel import loggable
from NatsuoBot.modules.sql import antiflood_sql as sql
from NatsuoBot.modules.connection import connected
